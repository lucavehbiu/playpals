      ...
      <div className="flex items-start space-x-4 p-4 bg-blue-50 rounded-lg">
        ...
        <div className="text-sm">
          ...
          <p className="text-blue-700">
            Verified phone numbers help build trust in the community and enable important
            notifications. Your phone number will remain private and not be shared with other users.
          </p>
        </div>
      </div>
