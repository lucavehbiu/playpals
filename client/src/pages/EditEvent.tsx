...
import { CalendarIcon, ArrowLeft, Loader2, CheckIcon, Image as ImageIcon } from 'lucide-react';
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>No participation fee for attendees</FormDescription>
                    </div>
                    <FormControl>
                      <Switch checked={field.value} onCheckedChange={field.onChange} />
                    </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Enter price in dollars (e.g., 5.00)</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button type="submit" disabled={updateMutation.isPending} className="flex gap-2">
